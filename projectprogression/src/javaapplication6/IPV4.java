...
public final class IPV4 extends javax.swing.JPanel {
     ...
     */
    public IPV4() throws SocketException, IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField1.setText("192.168.1.113");

        jLabel2.setText("SubnetMask");
        ...
        jTextField3.setText("192.168.1.1");

        jTextField4.setColumns(6);
        jTextField4.setText("192.168.1.1");

        jTextField5.setText("8.8.8.8");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (checkOS.isUnix()) {
            try {
                processDHCPForLinuxIpv4 processdhcpforlinuxipv4 = new processDHCPForLinuxIpv4(ipValue, netmaskValue, gatewayValue);
                processDNSForLinuxIpv4 processdnsforlinuxipv4 = new processDNSForLinuxIpv4(dnsone, dnstwo);
            ...
            processDHCPForWindowsIpv4 processdhcpforwindowsipv4 = new processDHCPForWindowsIpv4(ipValue, netmaskValue, gatewayValue);
            processDNSForWindowsIpv4 processdnsforwindowsipv4 = new processDNSForWindowsIpv4(dnsone, dnstwo);
