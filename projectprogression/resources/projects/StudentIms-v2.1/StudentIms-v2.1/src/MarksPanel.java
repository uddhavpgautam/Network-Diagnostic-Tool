...
public class MarksPanel extends JFrame {
    ...
    public MarksPanel(int index) {
        ...
        exitPanel.setBorder(BorderFactory.createEmptyBorder(12, 500, 10, 10));
        ...
        tabStudent.addTab("Select Class For Inserting Marks", new ImageIcon("img/list.png"),
                pnlList);
    ...
    public JPanel editDelete() {
        ...
        pnlEditDel.setBorder(BorderFactory.createEmptyBorder(0, 4, 10, 550));
            ...
            try {
                ...
                if (jt.isCellSelected(row, col)) {
                    ...
                    if (InsertMarks.listSub().length > 0) {
                        ...
                        dispose();
                        InsertMarks pnl = new InsertMarks(0);
                    } else {
    ...
    public static void main(String[] args) {
        ...
        MarksPanel me = new MarksPanel(0);
