...
public class TeacherPanel extends JFrame {
    ...
    public TeacherPanel(int index) {
        ...
        tabStudent.addTab("Add Teacher", new ImageIcon("img/add.png"), pnlAdd);
        tabStudent.addTab("List Teachers", new ImageIcon("img/list.png"),
                pnlList);
...
//			}
    ...
    public static void main(String[] args) {
        ...
        TeacherPanel me = new TeacherPanel(0);
