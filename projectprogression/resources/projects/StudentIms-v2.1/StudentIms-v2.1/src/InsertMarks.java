...
public class InsertMarks extends JFrame {
    ...
    public InsertMarks(int index) {
        ...
        exitPanel.setBorder(BorderFactory.createEmptyBorder(5, 500, 10, 10));
        ...
        tabStudent.addTab("Insert the marks By selecting the student.", new ImageIcon("img/add.png"), pnlAdd);
    ...
    public JPanel addStduentPanel() {
        ...
        jcbStdn = new JComboBox(InsertMarks.listStdn());
    ...
    public static String[] listStdn() {
        ...
        ArrayList<ArrayList<Object>> list = SqlLibrary.select("student", "*", "class_id='" + InsertMarks.stdClass + "'", lst);
        int rows = list.size();
        String[] cls = new String[rows + 1];
    ...
    public static String[] listSub() {
        ...
        ArrayList<ArrayList<Object>> list = SqlLibrary.select("subject", "*", "class_id='" + InsertMarks.stdClass + "'", lst);
        int rows = list.size();
                    ...
                    if (yes == JOptionPane.OK_OPTION) {
                        ...
                        try {
                            for (JTextField txt : flds) {
                                ...
                                if (txt.getText().equals("")) {
                                    SqlLibrary
                                            .Insert("marks", "std_id,sub_id",
                                                    "'" + stdnId + "','"
                                                    + sub_id + "'");
                                } else {
                                    int marks = Integer.parseInt(txt.getText());
                                    SqlLibrary.Insert("marks",
                                            "std_id,sub_id,mrk_obt", "'"
                                            + stdnId + "','" + sub_id
                                            + "','" + marks + "'");
                                }
                                i++;
                            }
                            JOptionPane.showMessageDialog(null, "The Mark is successfully Inserted", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String[] args) {
        ...
        InsertMarks me = new InsertMarks(0);
    }
}
